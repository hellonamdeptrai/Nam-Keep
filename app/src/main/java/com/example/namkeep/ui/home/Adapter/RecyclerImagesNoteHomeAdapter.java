...
public class RecyclerImagesNoteHomeAdapter {
...
////    @NonNull
////    @Override
////    public RecyclerImagesNoteAdapter.PhotoNoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
////        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_image_note, parent, false);
////        return new RecyclerImagesNoteAdapter.PhotoNoteViewHolder(view);
////    }
////
////    @Override
////    public void onBindViewHolder(@NonNull RecyclerImagesNoteAdapter.PhotoNoteViewHolder holder, int position) {
////        holder.imageView.setImageBitmap(list.get(position));
////    }
////
////    @Override

...
public class RecyclerImagesEditNoteAdapter extends RecyclerView.Adapter<RecyclerImagesEditNoteAdapter.PhotoNoteViewHolder>{

    private List<Bitmap> list;

    public RecyclerImagesEditNoteAdapter(List<Bitmap> list) {
        this.list = list;
    }
